...
- The daily spending guide divides the unspent GBP monthly cap (GBP 1,700 by default) across all calendar days remaining, including today. The cap is converted at the stored GBP/AED rate and can be edited in Settings. Eligible expenses entered in Transactions reduce today's balance; setup costs, deposits and card repayments do not. It is a maximum pacing guide, not a requirement to spend the full amount.
