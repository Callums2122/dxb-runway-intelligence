...
def test_ask_runway_is_separate_and_animates_received_answer(tmp_path: Path):
    ...
    assert [intelligence.tabs.tabText(index) for index in range(intelligence.tabs.count())]==["Opportunity check","Historical data","Vehicle grades","Market velocity","Deal Drive","Memory"]
