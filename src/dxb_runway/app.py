...
def main(argv: list[str] | None = None) -> int:
    ...
    QApplication.setOrganizationName("DXB Runway"); QApplication.setApplicationName("DXB RUNWAY"); QApplication.setApplicationVersion("1.2.10")
    app=QApplication(sys.argv[:1]); app.setStyle("Fusion"); app.setStyleSheet(APP_QSS)
    icon=resource_path("assets/dxb_runway.ico")
