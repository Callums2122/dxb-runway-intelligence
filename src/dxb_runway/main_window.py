...
from .screens import (
    BudgetsPage, CalendarPage, CustomerContactPage, DashboardPage, DebtPage, GoalsPage, InspectionPage, ReportsPage,
...
NAV_SECTIONS = [
    ("leads", "LEADS", COLORS["purple"], [("todo", "✓", "Today's to-do"), ("contacts", "◉", "Customer contact"), ("inspection", "⌕", "Inspection"), ("templates", "✉", "WhatsApp templates"), ("stock", "▦", "Stock level"), ("vehicles", "◈", "Vehicle desk"), ("calendar", "▣", "Calendar"), ("scenarios", "⌁", "Scenario lab")]),
